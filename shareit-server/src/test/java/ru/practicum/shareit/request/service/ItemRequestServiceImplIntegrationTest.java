...
class ItemRequestServiceImplIntegrationTest {
    ...
    void getAllByNotRequestorId() {
        ...
        List<ItemRequestDto> targetItemRequest = itemRequestService.getAllByNotRequestorId(userOwner.getId(), page);
    ...
    @Test
    void getRequestById() {
        Long itemRequestId = itemRequestService.createItemRequest(itemRequestDtoIn, userRequestor.getId()).getId();
